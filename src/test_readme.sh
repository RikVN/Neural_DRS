...
cur_dir=$(pwd)
SENT_FILE="${cur_dir}/DRS_parsing/data/pmb-2.2.0/sample/pre/train.txt.raw"
...
GOLD_DEV="${cur_dir}/DRS_parsing/data/pmb-2.2.0/gold/dev.txt"
...
# Reproduce F-scores of output folder
